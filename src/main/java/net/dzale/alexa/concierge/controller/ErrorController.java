...
public class ErrorController {
    ...
    @ExceptionHandler(value = {AlexaConciergeException.class})
    public ResponseEntity<String> handleAlexaConciergeException(AlexaConciergeException ex, WebRequest request) {
        log.error("Caught AlexaConciergeException: "+ex.getMessage());
        return new ResponseEntity<String>(ex.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR);
    }

    @ExceptionHandler(value = {AlexaConciergeDataException.class})
    public ResponseEntity<String> handleAlexaConciergeException(AlexaConciergeDataException ex, WebRequest request) {
        log.error("Caught AlexaConciergeDataException: "+ex.getMessage());
